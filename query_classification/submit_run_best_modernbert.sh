#!/bin/bash
#SBATCH --job-name=query_run_best
...
jobname="query_run_best_${CLASSIFICATION_TYPE}"
...
cmd=(python3 run_best_modernbert.py --classification-type "${CLASSIFICATION_TYPE}" --max-len "${MAX_LEN}" --batch-size "${BATCH_SIZE}")
